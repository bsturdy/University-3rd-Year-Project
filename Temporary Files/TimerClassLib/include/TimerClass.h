...
class TimerClass
{
    private:    
        ...
        static const int CyclicTaskStackSize = 2048;                    // Size given to cyclic task
    ...
    public:
        ...
        bool SetupCyclicTask(void (*TaskToRun)(void*), float CycleTimeInMs, 
                            float WatchdogTime, uint16_t Prescalar, uint8_t CoreToUse);            // Takes a task input and converts it into a cyclically executed task with watchdog protection
